...
const RegisterForm = ({ loggedInUser, userIsLoggedIn }) => {
  ...
  const registerUser = (
    ...
    const firstInitial = firstName.substring(1, 0);
    const lastInitial = lastName.substring(1, 0);
    const userAvatarText = firstInitial + lastInitial;
